...
[English README](README_EN.md) · [开源说明](#开源说明) · [许可证](LICENSE)
...
<p align="center">
<img src="images/console-welcome.png" alt="Web 控制台" width="85%" /><br/>
...
- 音频功放 MAX98357AEWL+ 是 WLP-9（1.34×1.34 mm），本质上是芯片裸片 + 9 颗焐球的 BGA 类封装，返修完全依赖 X-Ray，手工场景下出问题几乎只能换一颗
...
- 上游第三方代码（如 `components/display/lv_v9.3/`、`components/display/lv_port/`）保留各自原始的 README 与许可，不在本仓库的 MIT 范围内重新声明
