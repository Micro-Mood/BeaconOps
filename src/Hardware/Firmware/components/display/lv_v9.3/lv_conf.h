...
#define LV_FONT_SOURCE_HAN_SANS_SC_16_CJK   0  /**< Replaced by generated MiSans Bold font in components/ui */
...
#define LV_USE_CALENDAR   1
    ...
    #define LV_CALENDAR_WEEK_STARTS_MONDAY 0
        ...
        #define LV_CALENDAR_DEFAULT_DAY_NAMES {"1", "2", "3", "4", "5", "6", "7"}
    #else
        #define LV_CALENDAR_DEFAULT_DAY_NAMES {"7", "1", "2", "3", "4", "5", "6"}
    #endif
...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'B'        /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
